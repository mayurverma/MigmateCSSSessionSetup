#if !defined(SRC__PLATFORM__SRC__PLATFORMINTERNAL_H)
#define      SRC__PLATFORM__SRC__PLATFORMINTERNAL_H
//******************************************************************************
/// \file
///
/// Provides platform-layer management: internal types
///
/// \addtogroup platform
/// @{
//******************************************************************************
...
typedef struct
{
    uint32_t criticalSectionNestLevel;
} PlatformStateT;
...
extern PlatformStateT platformState;

// Initialises the Driver components
extern ErrorT PlatformInitDrivers(void);

/// @} endgroup platform
#endif  // !defined(SRC__PLATFORM__SRC__PLATFORMINTERNAL_H)
