...
/// The contents of this table and the comparators table must be kept in sync
...
const PatchMgrPatchedFunctionAddressT prodTestAppPatchedFunctionTable[PROD_TEST_APP_NUM_PATCHED_FUNCTIONS] =
{
...
const PatchMgrComparatorFunctionAddressT prodTestAppComparatorTable[PROD_TEST_APP_NUM_PATCHED_FUNCTIONS] =
{
