...
class VerificationAppDebugIdGenerator():
    """Debug id header generator class
    """
    ...
    PYTHON_HEADER = \
        ...
        '\n' \
        '@unique\n' \
        'class DebugId(IntEnum):\n' \
        '    """Verification App debug id enumeration."""\n'
        ...
        with open(self._csv_filename, newline='') as csvfile:
            ...
            for row in entries:
                if "" != row['Name'].strip():
                    ...
                    if self._debug: print("Evaluating id: {}: {}".format(phase_name, phase_value))
...
generator = VerificationAppDebugIdGenerator(args.csvfile, 'VERIFICATION_APP_DEBUG_ID', args.debug)
if args.validate:
    generator.validate()

# Generate C and Python system phases header files
print('Generating debug ids...')
generator.generate_c(os.path.join(args.output, 'VerificationAppDebugId.h'))
generator.generate_python(os.path.join(args.scripts, 'verification_app_debug_id.py'))
