#if !defined(TEST__HARDFAULT__INC__HARDFAULT_TEST_H)
#define      TEST__HARDFAULT__INC__HARDFAULT_TEST_H
//******************************************************************************
/// \file
///
/// System integration - sytem initialization tests
///
...
extern int system_test(void);

/// @} endgroup inittest
#endif // !defined(TEST__HARDFAULT__INC__HARDFAULT_TEST_H)
