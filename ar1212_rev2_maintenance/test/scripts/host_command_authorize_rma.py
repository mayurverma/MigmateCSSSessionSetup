...
#
####################################################################################
# Camera AuthorizeRMA host command
####################################################################################
import logging
import struct
...
class HostCommandAuthorizeRmaParams(HostCommandParams):
    """Host command Authorize RMA parameters."""
...
class HostCommandAuthorizeRmaResponse(HostCommandResponse):
    """Host command Authorize RMA response."""
    pass

class HostCommandAuthorizeRma():
    """Authorize RMA command class."""

    def __init__(self, session):
        self.__logger = logging.getLogger(self.__class__.__name__)
        self.__session = session
        self.__host_command_code = HostCommandCode.AUTHORIZE_RMA
    ...
    def execute(self,
        ...
        # Issue AuthorizeRma command
        AuthorizeRmaParams = struct.pack("<LL",
                             extClockHz,
                             pllClockHz,
                            )


        params = HostCommandAuthorizeRmaParams()
        response = HostCommandAuthorizeRmaResponse()

        params.encryptedParams = AuthorizeRmaParams
