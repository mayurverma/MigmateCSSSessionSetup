...
class HostCommandCode(IntEnum):
    ...
    OTPM_BLANK_CHECK = 0x8840             # (0x8840) Run a blank check on the OTPM (Configure stage)
    OTPM_VERIFY = 0x8841                  # (0x8841) Verify the integrity of the OTPM post-programming (Debug phase)
